...
<body class="p-8">
    <div class="max-w-3xl mx-auto print-container shadow-lg p-10 border border-gray-200 rounded">
        <div class="text-center mb-8 border-b-2 border-black pb-4">
            ...
            <h2 class="text-2xl mt-2">سند قبض</h2>
        </div>
    ...
    <div class="max-w-3xl mx-auto mt-8 text-center no-print">
        <button onclick="window.print()" class="bg-indigo-600 text-white px-8 py-3 rounded text-lg font-bold hover:bg-indigo-700">🖨️ طباعة سند قبض</button>
        <?php if ($back_tid): ?>
