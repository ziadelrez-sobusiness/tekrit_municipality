    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-blue-50 border-r-4 border-blue-500 text-blue-800 p-4 mb-6 rounded shadow-sm">
            <h3 class="font-bold mb-1">ℹ️ توضيح عن الصناديق:</h3>
                الرصيد الافتتاحي هو المبلغ الموجود في الصندوق عند بدء استخدام النظام.<br>
                الرصيد الحالي هو الرصيد الذي يتغير تلقائيًا بعد تسجيل المداخيل والمصاريف.<br>
                    ...
                    <table class="w-full text-right text-sm">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b hover:bg-gray-50 <?= !$cb['is_active'] ? 'opacity-50' : '' ?>">
                                ...
                                <td class="p-2 font-bold text-xs"><?= htmlspecialchars($cb['currency_name']) ?></td>
                                ...
                                <td class="p-2 flex gap-2 text-xs flex-wrap">
                                    <a href="accounting_cashbox_statement.php?cashbox_id=<?= $cb['id'] ?>" class="bg-indigo-100 text-indigo-800 px-2 py-1 rounded hover:bg-indigo-200 font-bold whitespace-nowrap">📋 كشف الحركة</a>
                                    <a href="?edit_id=<?= $cb['id'] ?>" class="bg-yellow-100 text-yellow-800 px-2 py-1 rounded hover:bg-yellow-200">تعديل</a>
                                    <?php 
                                        $token_val = $_SESSION['csrf_token'] ?? '';
                                    ?>
