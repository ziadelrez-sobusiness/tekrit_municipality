    ...
    <div class="min-h-screen p-6">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <p class="text-gray-600 mt-2">إدارة العملات وأسعار الصرف وإعدادات النظام العامة</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md">
                <div class="border-b border-gray-200">
                    <nav class="flex space-x-8 px-6">
                        <button onclick="showTab('currencies')" class="tab-button py-4 px-2 border-b-2 border-blue-500 text-blue-600 font-medium">
                            💱 إدارة العملات
                        </button>
                        ...
                        <button onclick="showTab('system')" class="tab-button py-4 px-2 border-b-2 border-transparent text-gray-500 hover:text-gray-700 font-medium">
                            ⚙️ إعدادات عامة
                        </button>
                    </nav>
                </div>
                ...
                <!-- Tab: إدارة العملات -->
                <div id="currencies-tab" class="tab-content active p-6">
                        ...
                        <div class="bg-gray-50 rounded-lg p-6">
                            ...
                            <form method="POST" class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" name="currency_code" maxlength="3" placeholder="USD" required 
                                ...
                                <div>
                                    ...
                                    <input type="text" name="currency_name" placeholder="الدولار الأمريكي" required 
                                           class="w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">رمز العملة</label>
                                    <input type="text" name="currency_symbol" placeholder="$" required 
                                           class="w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">سعر الصرف مقابل الدينار العراقي</label>
                                    <input type="number" step="0.0001" min="0" name="exchange_rate" placeholder="1320.0000" required 
                                           class="w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                ...
                                <div class="border border-gray-200 rounded-lg p-4">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <input type="number" step="0.0001" min="0" 
                                               ...
                                               <?= $currency['currency_code'] === 'IQD' ? 'readonly' : '' ?>
                                               class="w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 <?= $currency['currency_code'] === 'IQD' ? 'bg-gray-100' : '' ?>">
                                        
                                        <div class="flex items-center">
                                            <input type="checkbox" 
                                                   name="currencies[<?= $currency['id'] ?>][is_active]" 
                                                   <?= $currency['is_active'] ? 'checked' : '' ?>
                                                   <?= $currency['currency_code'] === 'IQD' ? 'disabled checked' : '' ?>
                ...
                <div id="system-tab" class="tab-content p-6">
                    ...
                    <div class="mt-8 border-t border-gray-200 pt-6">
                        <h3 class="text-xl font-semibold mb-4">🔧 أدوات الصيانة</h3>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <button onclick="alert('هذه الميزة قيد التطوير')" 
