...
<head>
    ...
    <title>إدارة أعضاء المجلس البلدي (نهائي)</title>
    ...
    <style>
        ...
        .image-preview-container { border: 2px dashed #d1d5db; border-radius: 8px; transition: all 0.3s ease; }
        .image-preview-container:hover { border-color: #6366f1; background-color: #f8fafc; }
        .image-preview-container.has-image { border-style: solid; border-color: #10b981; }
    </style>
</head>
<body class="bg-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-gray-900">إدارة أعضاء المجلس البلدي (نهائي)</h1>
                        <p class="text-sm text-gray-500">نظام كامل مع معاينة وحفظ الصور</p>
                    </div>
                </div>
    ...
    <div class="max-w-7xl mx-auto py-6 px-4">
            ...
            <form method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    <div class="lg:col-span-1">
                        ...
                        <div id="imagePreviewContainer" class="image-preview-container w-full h-48 flex items-center justify-center bg-gray-50 relative overflow-hidden">
                            <div id="placeholderContent" class="text-center">
                                ...
                                <p class="text-xs text-gray-500">اضغط أو اسحب الصورة هنا</p>
                            </div>
                        ...
                        <input type="file" 
                               ...
                               accept="image/*" 
                               id="imageInput"
                               class="mt-2 w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100"
                                    ...
                                    <div class="flex items-center">
                                        <div class="h-12 w-12 flex-shrink-0">
                                            <?php if ($member['profile_picture']): ?>
                                                ...
                                                <div class="h-12 w-12 rounded-full bg-gradient-to-br from-indigo-400 to-purple-500 flex items-center justify-center text-white font-bold text-lg" style="display: none;">
        ...
        <!-- Edit Modal -->
        <div id="editModal" class="fixed inset-0 bg-gray-600 bg-opacity-75 hidden overflow-y-auto h-full w-full z-50" style="backdrop-filter: blur(4px);">
                ...
                <form method="POST" enctype="multipart/form-data" id="editForm" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                        ...
                        <div class="lg:col-span-1">
                            ...
                            <div id="editImageContainer" class="w-full h-48 border-2 border-gray-300 rounded-lg overflow-hidden bg-gray-50 flex items-center justify-center">
                            ...
                            <div id="editImagePreview" class="mt-2 hidden">
                                <p class="text-sm text-gray-600 mb-1">الصورة الجديدة:</p>
                                <img id="editPreviewImg" class="w-full h-32 object-cover rounded border">
                            </div>
                        </div>
