        ...
        <table class="w-full text-right">
            <thead class="bg-gray-800 text-white">
                <tr>
                    ...
                    <th class="p-3">الواردات المقدرة (ل.ل)</th>
                    <th class="p-3">النفقات المقدرة (ل.ل)</th>
                    <th class="p-3">الرصيد المقدر (ل.ل)</th>
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="p-3 flex gap-2">
                        <a href="?action=view&id=<?= $b['id'] ?>" class="bg-blue-100 text-blue-700 px-3 py-1 rounded hover:bg-blue-200 font-bold text-sm">التفاصيل والتعديل</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
