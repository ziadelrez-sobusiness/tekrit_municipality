...
$menu_items = [
    ...
    [
        ...
        'items' => [
            ...
            [
                'permission' => 'finance_view',
                'url' => 'modules/accounting_cashbox_statement.php',
                'icon' => '📋',
                'label' => 'كشف حركة الصندوق'
            ],
            [
                'permission' => 'finance_view',
            ...
            [
                ...
                'url' => 'modules/municipal_budget.php',
                'icon' => '🏛️',
                'label' => 'الموازنة البلدية'
            ],
            [
                'permission' => 'budgets_view',
                'url' => 'modules/budgets.php',
                'icon' => '📊',
                'label' => 'الميزانيات القديمة (للمراجعة فقط)'
            ],
            [
                'permission' => 'budgets_view',
                'url' => 'modules/budgets_report.php',
                'icon' => '📉',
                'label' => 'تقارير الميزانية القديمة (للمراجعة فقط)'
            ],
            [
                'permission' => 'budgets_view',
