...
<head>
    ...
    <script>
        ...
        // Add event listeners when Alpine is ready
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-gray-900">إدارة أعضاء المجلس البلدي</h1>
                        <p class="text-sm text-gray-500">إضافة وتعديل ومتابعة أعضاء المجلس</p>
                    </div>
                </div>
