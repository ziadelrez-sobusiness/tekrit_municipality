            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50 <?= $is_cancelled ? 'cancelled-row' : '' ?>">
                    ...
                    <td class="p-2 font-mono whitespace-nowrap">
                        <?php if ($doc_num): ?>
                            <a href="accounting_transaction_view.php?id=<?= $tx['id'] ?>" class="text-indigo-600 hover:underline no-strike"><?= htmlspecialchars($doc_num) ?></a>
                        <?php else: ?>—<?php endif; ?>
                    </td>
                    ...
                    <td class="p-2 no-print">
                        <div class="flex gap-1 flex-wrap no-strike">
                            <a href="accounting_transaction_view.php?id=<?= $tx['id'] ?>" class="bg-blue-100 text-blue-700 px-2 py-0.5 rounded hover:bg-blue-200">عرض</a>
                            <?php if (!$is_cancelled): ?>
                                <a href="accounting_transaction_view.php?id=<?= $tx['id'] ?>&edit=1" class="bg-yellow-100 text-yellow-700 px-2 py-0.5 rounded hover:bg-yellow-200">تعديل</a>
                                <a href="accounting_transaction_cancel.php?id=<?= $tx['id'] ?>" class="bg-red-100 text-red-700 px-2 py-0.5 rounded hover:bg-red-200 font-bold"
