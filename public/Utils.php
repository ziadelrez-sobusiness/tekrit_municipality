...
class Utils {
    ...
    /**
     * تحويل التاريخ إلى التاريخ الهجري (تقريبي)
     */
    public static function toHijriDate($date) {
        // هذه دالة تقريبية للتحويل للتاريخ الهجري
        // يمكن استخدام مكتبة أكثر دقة في الإنتاج
        $gregorianDate = new DateTime($date);
        $hijriYear = $gregorianDate->format('Y') - 579;
        return $hijriYear . 'هـ';
    }
