-- تحديث جدول الصلاحيات الموجود - إضافة حقل category
-- بلدية تكريت - تحديث نظام الصلاحيات

USE tekrit_municipality;

-- ═══════════════════════════════════════════════════════════════════════════════
-- الخطوة 1: إضافة حقل category إلى الجدول الموجود
-- ═══════════════════════════════════════════════════════════════════════════════

ALTER TABLE permissions
ADD COLUMN category VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
COMMENT 'الفئة: general_admin, finance, projects, etc.' AFTER description;

-- إضافة index على category
ALTER TABLE permissions ADD INDEX idx_category (category);
...
-- ═══════════════════════════════════════════════════════════════════════════════
-- الخطوة 2: حذف البيانات القديمة (اختياري - احذف هذا السطر إذا كنت تريد الاحتفاظ بالصلاحيات القديمة)
-- ═══════════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════════
-- الخطوة 3: إدخال الصلاحيات الجديدة
-- ═══════════════════════════════════════════════════════════════════════════════
...
INSERT INTO permissions (permission_name, display_name, description, category, module_name, page_url, icon, sort_order) VALUES
-- إدارة البلدية
...
-- ═══════════════════════════════════════════════════════════════════════════════
-- رسائل الإتمام والتحقق
-- ═══════════════════════════════════════════════════════════════════════════════

SELECT '✅ تم تحديث جدول الصلاحيات بنجاح!' as message;
...
SELECT '✅ جاهز للاستخدام! يمكنك الآن فتح صفحة الصلاحيات' as status;
